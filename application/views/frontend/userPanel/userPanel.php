...
<body class="bg-gray-100 flex min-h-screen">
    ...
    <div id="sidebar" class="w-64 bg-gray-800 text-white p-6 flex flex-col h-screen fixed">
        <h2 class="text-2xl font-bold mb-6 text-center">Kullanıcı Paneli</h2>
        <ul class="flex-1">
            <li class="mb-4">
                <a href="<?php echo base_url('user'); ?>" class="block py-2 px-4 rounded hover:bg-gray-700">Ana Sayfa</a>
            </li>
            <li class="mb-4">
                <a href="<?php echo base_url('criteria'); ?>" class="block py-2 px-4 rounded hover:bg-gray-700">Kriterler</a>
            </li>
            <li class="mb-4">
                <a href="<?php echo base_url('jury'); ?>" class="block py-2 px-4 rounded hover:bg-gray-700">Jüri ekleme</a>
            </li> 
        </ul>
    </div>
